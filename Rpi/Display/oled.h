...
namespace Rpi
{
    ...
    public:
        ...
        FW_STATIC_ASSERT(CHARACTER_WIDTH * LINE_LENGTH == WIDTH);
        FW_STATIC_ASSERT(LINE_SIZE == CHARACTER_HEIGHT * WIDTH);
        FW_STATIC_ASSERT(LINE_SIZE == LINE_LENGTH * CHARACTER_WIDTH * CHARACTER_HEIGHT);
        FW_STATIC_ASSERT(LINE_MAX_N == SCREEN / LINE_SIZE);
