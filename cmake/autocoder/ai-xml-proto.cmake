...
set(ai_xml_HANDLES_INDIVIDUAL_SOURCES TRUE)
...
function(ai_xml_get_generated_files AC_INPUT_FILE)
    ...
    if(AC_INPUT_FILE MATCHES "^${CMAKE_CURRENT_BINARY_DIR}.*")
        ...
        __ai_xml_ai_info("${AC_INPUT_FILE}" "${MODULE_NAME}")
    endif()
...
####
function(__ai_xml_ai_info XML_PATH MODULE_NAME)
    ...
    set(PARSER_PATH "${PROJECT_SOURCE_DIR}/cmake/autocoder/ai-parser/ai_parser.py")
...
function(ai_xml_regenerate_memo OUTPUT MEMO_FILE SOURCES_INPUT)
